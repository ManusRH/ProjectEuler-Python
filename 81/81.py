...
for y in range(y_lim):
    for x in range(x_lim):
        if y+1 != y_lim and x+1 != x_lim:
            G[str(grid[y][x]) +" - " + str(x) + ", " + str(y)] = {str(grid[y][x+1]) + " - " + str(x+1) + ", " + str(y): grid[y][x+1], str(grid[y+1][x]) + " - " + str(x) + ", " + str(y+1): grid[y+1][x]}

        elif y+1 == y_lim and x+1 != x_lim:
            G[str(grid[y][x]) +" - " + str(x) + ", " + str(y)] = {str(grid[y][x+1]) + " - " + str(x+1) + ", " + str(y): grid[y][x+1]}

        elif x+1 == y_lim and y+1 != x_lim:
